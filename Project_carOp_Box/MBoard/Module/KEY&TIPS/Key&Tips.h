...
#define K1	GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_12)		//按键1监测
#define K2	GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_13)		//按键2监测
#define K3	GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_6)		//按键1监测
#define K4	GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_7)		//按键2监测
#define K5	GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_8)		//按键1监测
#define K6	GPIO_ReadInputDataBit(GPIOC, GPIO_Pin_9)		//按键2监测
...
#define KEY_VALUE_3	0x0030		//按键键值1
#define KEY_VALUE_4	0x0040		//按键键值2
#define KEY_VALUE_5	0x0050		//按键键值1
#define KEY_VALUE_6	0x0060		//按键键值2
